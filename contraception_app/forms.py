...
class QuestionnaireForm(forms.Form):
    ...
    question12 = forms.ChoiceField(label='12. Have you ever been diagnosed with a pelvic infection (PID)?', choices=YES_NO_CHOICES, widget=forms.RadioSelect)
    question13 = forms.ChoiceField(label='13. Do you have a current sexually transmitted infection (STI)?', choices=YES_NO_CHOICES, widget=forms.RadioSelect)
    question14 = forms.ChoiceField(label='14. Have you ever been diagnosed with cervical cancer?', choices=YES_NO_CHOICES, widget=forms.RadioSelect) 
    question15 = forms.ChoiceField(label='15. Do you have a history of HIV/AIDs?', choices=YES_NO_CHOICES, widget=forms.RadioSelect)
    question16 = forms.ChoiceField(label='16. Are you on hormone replacement therapy for gender-affirming care?', choices=YES_NO_CHOICES, widget=forms.RadioSelect)
