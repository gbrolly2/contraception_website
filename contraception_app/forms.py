...
class QuestionnaireForm(forms.Form):
    ...
    question17 = forms.ChoiceField(label='17. Do you want to avoid birth control options that contain hormones?', choices=YES_NO_NO_PREFERENCE_CHOICES, widget=forms.RadioSelect)
